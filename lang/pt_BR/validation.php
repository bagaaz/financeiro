...
return [
    ...
    | de validação. Algumas dessas regras têm várias versões, como as regras
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar o marcador de posição de
    | atributo por algo mais amigável ao leitor, como "Endereço de E-Mail"
    | em vez de "email". Isso simplesmente ajuda a tornar nossa mensagem
    | mais expressiva.
    |
    */
